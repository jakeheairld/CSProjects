...
gmsh.merge(os.path.join(path, os.pardir, 'Tutorials/posFiles/view1.pos'))
gmsh.merge(os.path.join(path, os.pardir, 'Tutorials/posFiles/view1.pos'))
gmsh.merge(os.path.join(path, os.pardir, 'Tutorials/posFiles/view4.pos'))  # contains 2 views inside
