...
if pore_type == "circle":
    ...
    models = [
        PoreGenerator.generate_pores_square(num_pores, side_length_min, side_length_max, plane_width, plane_height)
        for _ in range(num_models)]
...
for m in range(num_models):
    ...
    XdmfConverter2D.convert_msh_to_xdmf(f"../SavedMeshFiles/mesh{m + 1}.msh", f"../SavedXdmfFiles/mesh{m + 1}.xdmf")
